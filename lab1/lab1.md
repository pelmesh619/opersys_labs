...
| `-le`    | меньше или равно | `[ 5 -le 5 ]` |
| `-gt`    | больше чем       | `[ 8 -gt 3 ]` |
| `-ge`    | больше или равно | `[ 8 -ge 8 ]` |
| `==`     | равно            | `(( 3 == 3 ))` |
| `!=`     | не равно         | `(( 3 != 5 ))` |
| `<`      | меньше чем       | `(( 2 < 5 ))`  |
...
| `==`     | строки равны (в `[[ ]]`)                 | `[[ $a == $b ]]`   |
| `!=`     | строки не равны                          | `[ "$a" != "$b" ]` |
| `<`      | первая строка меньше (лексикографически) | `[[ $a < $b ]]`    |
| `>`      | первая строка больше (лексикографически) | `[[ $a > $b ]]`    |
| `-z`     | строка пуста                             | `[ -z "$a" ]`      |в
